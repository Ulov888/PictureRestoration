...
### 1.2 NAFNet介绍
- [NAFNet](https://arxiv.org/abs/2204.04676)是旷视研究院提出的用于图像复原的模型，在图像去模糊、去噪都取得了很好的性能，不仅**计算高效同时性能优于之前SOTA方案**，效果如下图所示。在双目超分任务上，基于NAFNet的双目超分模型NAFSSR**获得NTIRE 2022的双目超分赛道冠军**
...
4k图片处理前：
 <img src="https://github.com/Ulov888/PictureRestoration/blob/master/4kpictures/inputs/beautiful.png" width = "800" height = "500" alt="图片名称" align=center />

4k图片处理后：
 <img src="https://github.com/Ulov888/PictureRestoration/blob/master/4kpictures/outputs/beautiful_restoration.png" width = "800" height = "500" alt="图片名称" align=center />
